...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "validity", sa.String(length=100), nullable=True
        ),  # 有效性（如：部门规范性文件）- 从50增加到100
    ...
    op.create_index(
        op.f("ix_policies_category"), "policies", ["category"], unique=False
    )
    op.create_index(op.f("ix_policies_level"), "policies", ["level"], unique=False)
    op.create_index(
        op.f("ix_policies_source_name"), "policies", ["source_name"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_attachments_policy_id", "attachments", ["policy_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_scheduled_task_runs_id"), "scheduled_task_runs", ["id"], unique=False
    )
    op.create_index(
        "idx_task_runs_task_id", "scheduled_task_runs", ["task_id"], unique=False
    )
    op.create_index(
        "idx_task_runs_run_time", "scheduled_task_runs", ["run_time"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_system_config_category"), "system_config", ["category"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_backup_records_created_at"),
        "backup_records",
        ["created_at"],
        unique=False,
    )
