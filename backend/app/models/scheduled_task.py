...
from sqlalchemy import Column, BigInteger, Integer, String, Text, Boolean, DateTime, JSON, Index, ForeignKey
...
class ScheduledTaskRun(Base):
    ...
    id = Column(BigInteger, primary_key=True, index=True)
    task_id = Column(BigInteger, ForeignKey("scheduled_tasks.id", ondelete="CASCADE"), nullable=False, index=True)
