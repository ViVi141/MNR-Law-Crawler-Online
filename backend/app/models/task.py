...
from sqlalchemy import Column, BigInteger, Integer, String, Text, DateTime, ForeignKey, JSON, Index
...
class TaskPolicy(Base):
    ...
    policy_id = Column(BigInteger, ForeignKey("policies.id", ondelete="CASCADE"), primary_key=True)
